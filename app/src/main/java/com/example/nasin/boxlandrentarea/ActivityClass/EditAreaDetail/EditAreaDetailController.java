...
public class EditAreaDetailController {
    ...
    public static AreaZone getAreaZone(final String zoneId) {
        final AreaZone areaZone = new AreaZone();
    ...
    public void saveEditArea(AreaDetail areaDetail) {
        ...
        area.child("Zone").setValue(areaDetail.getAreazone().getZoneId());
